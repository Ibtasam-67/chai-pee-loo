...
const TeaOrder = () => {
  const data = useSelector((state) => state.tea.data);
                  ...
                  <Table size="small" aria-label="a dense table">
                    <TableHead>
                      <TableRow>
                        ...
                        <CustomTableCell name="Chay Quantity" isHeader />
                        <CustomTableCell name="Sugar Quantity" isHeader />
                        <CustomTableCell name="Edit" isHeader />
                        <CustomTableCell name="Delete" isHeader />
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {(rowsPerPage > 0
                        ...
                        return (
                          ...
                          >
                            ...
                            <CustomTableCell name={product.chayQuant} />
                            <CustomTableCell name={product.sugar} />
                          </TableRow>
                        );
                      })}
                    </TableBody>
